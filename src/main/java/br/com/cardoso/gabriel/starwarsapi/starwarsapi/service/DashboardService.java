...
import br.com.cardoso.gabriel.starwarsapi.starwarsapi.repository.RebelResourceRepository;
...
public class DashboardService {
    ...
    private Map<String, Map<String, Double>> getRebelResourcesMean() {
        ...
        Map<String, Double> resourcesMean = getRebels().stream()
                ...
                .collect(Collectors
                        .groupingBy(rebelResource -> rebelResource.getResource().getDescricao(),
